...
void loop() {
  ...
  Serial.println("1.Encrypt record with Blowfish + Serpent");
  Serial.println("2.Decrypt record with Blowfish + Serpent");
  while (!Serial.available()) {}
  int x = Serial.parseInt();
  if(x == 1){
    encrypt_with_bl_serp();
  }
  if(x == 2){
    decrypt_rec_with_bl_serp();
  }
}
