...
public class MainClass {
    ...
    public static void gen_keys() {
		...
		SecureRandom sk0hsk = new SecureRandom();
		int num_of_chars_in_hsk = 212 + sk0hsk.nextInt(100);
		for (int i = 0; i < num_of_chars_in_hsk; i++) {
			SecureRandom sk0 = new SecureRandom();
				m = sk0.nextInt(3);
				m1 = sk0.nextInt(2);
				StringBuilder str0 = new StringBuilder();
				if (m == 0)
					str0.append((char)(65 + (sk0.nextInt(26))));
				if (m == 1)
					str0.append((char)(97 + (sk0.nextInt(26))));
				if (m == 2)
		...
		for (int i = 0; i < 8; i++) {
			...
			for (int j = 0; j < 4; j++) {
				...
				if (m == 0)
					str1.append((char)(97 + (sk1.nextInt(6))));
				if (m == 1)
					str1.append((char)(48 + (sk1.nextInt(10))));
				if (m1 == 0)
					str1.append((char)(97 + (sk1.nextInt(6))));
				if (m1 == 1)
					str1.append((char)(48 + (sk1.nextInt(10))));
	  ...
	  public static void main(String[] args){
	      ...
	      */
		  StringBuilder slt = new StringBuilder();
	        ...
	        JButton genr = new JButton("Generate keys for Cipherbox V2.0");
