...
public class Editor {
    static JMenuBar mb;
    static JMenu m,m1;
    static JMenuItem c, o, sv, q, sk, gk;
    ...
    public static void generate_key_for_tw() {
	  ...
	  public static void main(String[] args){
	      ...
	      */
		  StringBuilder slt = new StringBuilder();
	        ...
	        JButton genr = new JButton("Generate keys for Cipherbox V3.0");
	        q = new JMenuItem("Quit");
	        gk = new JMenuItem("Generate key");
